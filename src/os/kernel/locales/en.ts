const en: Record<string, string> = {
    ...
    "settings.developer.warmup": "Warm Up Runtime",
    "settings.developer.warmup.desc": "Pre-boot the runtime silently after refresh for faster app launch.",
    "settings.developer.compatibility": "Compatibility Mode (Disable COEP)",
    "settings.developer.compatibility.desc": "Disable security headers to allow loading external images.",
    "settings.developer.compatibility.warning": "Warning: Disables Terminal & AI Builder.",
    "settings.developer.compatibility.confirm_enable": "Enable Compatibility Mode?\nThis will disable WebContainer (Terminal/AI Builder) but allow external images to load.\nPage will reload.",
    "settings.developer.compatibility.confirm_disable": "Disable Compatibility Mode?\nThis will re-enable WebContainer features.\nPage will reload.",
    ...
    "menu.changeIcon.lucide": "Choose Lucide Icon",
