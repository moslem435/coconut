const zh: Record<string, string> = {
    ...
    "settings.developer.compatibility": "兼容模式 (禁用 COEP)",
    "settings.developer.compatibility.desc": "禁用安全隔离头以允许加载外部图片资源。",
    "settings.developer.compatibility.warning": "警告：启用此模式将导致终端和 AI 构建器无法使用。",
    "settings.developer.compatibility.confirm_enable": "确定要启用兼容模式吗？\n这将允许加载外部图片，但会导致 WebContainer (终端/AI 构建器) 无法使用。\n页面将会刷新。",
    "settings.developer.compatibility.confirm_disable": "确定要禁用兼容模式吗？\n这将恢复 WebContainer 功能，但外部图片可能无法加载。\n页面将会刷新。",
