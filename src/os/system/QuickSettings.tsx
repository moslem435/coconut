    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed bottom-16 right-4 w-80 bg-[var(--os-bg-panel)] backdrop-blur-2xl border border-[var(--os-border)] rounded-2xl shadow-2xl p-4 z-[5000] text-[var(--os-text-primary)]"
        >
          {/* Header */}
          <div className="flex justify-between items-center mb-4 px-1">
            <h3 className="font-semibold text-sm tracking-wide">Quick Settings</h3>
