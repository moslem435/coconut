            ...
            [
                {
                    ...
                    onClick: async () => {
                        try {
                            const { performFactoryReset } = await import('@/os/kernel/core-services/systemReset');
            ...
            [
                {
                    ...
                    onClick: async () => {
                        try {
                            const { performFactoryReset } = await import('@/os/kernel/core-services/systemReset');
                            await performFactoryReset(selectedKeys);
                        } catch (error) {
                ...
                <div className="space-y-3">
                    {stats.map((stat) => (
                        <div
                            ...
                            className={`flex items-center justify-between p-3 rounded-xl border transition-all cursor-pointer ${stat.checked
                                ? 'bg-[var(--os-bg-base)]/60 border-[var(--os-border)]/50'
                                : 'bg-[var(--os-bg-base)]/20 border-transparent opacity-60 hover:opacity-80'
                                }`}
                        >
                            <div className="flex items-center gap-3">
                                <div className={`flex items-center justify-center min-w-5 h-5 rounded border transition-colors ${stat.checked
